function [TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy,TY] = elm_kernel(train_data, test_data, Elm_Type, Regularization_coefficient, Kernel_type, Kernel_para)
